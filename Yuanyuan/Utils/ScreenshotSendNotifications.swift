...
enum ScreenshotSendNotifications {
    private static let threadId = "yuanyuan.screenshot_send"
    private static let sendingId = "yuanyuan.screenshot_send.sending"
    private static let resultId = "yuanyuan.screenshot_send.result"
