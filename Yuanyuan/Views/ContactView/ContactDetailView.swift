                        ...
                        VStack(spacing: 24) {
                            ...
                            VStack(spacing: 12) {
                                ...
                                if let company = contact.company, !company.isEmpty {
                                    ContactInfoRow(icon: "building.2.fill", title: "公司", content: company, themeColor: themeColor)
                                }
                                
                                // 身份（职位）
                                if let identity = contact.identity, !identity.isEmpty {
                                    ContactInfoRow(icon: "briefcase.fill", title: "身份", content: identity, themeColor: themeColor)
                                }
                                
                                // 兴趣爱好
                                if let hobbies = contact.hobbies, !hobbies.isEmpty {
                                    ContactInfoRow(icon: "heart.fill", title: "兴趣爱好", content: hobbies, themeColor: themeColor)
                                }
                                
                                // 与我关系
                                if let relationship = contact.relationship, !relationship.isEmpty {
                                    ContactInfoRow(icon: "person.2.fill", title: "与我关系", content: relationship, themeColor: themeColor)
                                }
                            }
                                ...
                                Button(action: {
                                    ...
                                    .background(
                                        RoundedRectangle(cornerRadius: 16)
                                            .fill(themeColor)
                                            .shadow(color: themeColor.opacity(0.3), radius: 8, x: 0, y: 2)
                                    )
                                }
                                .buttonStyle(ScaleButtonStyle())
                                .disabled(isSyncing)
            ...
            if showCallButton, let action = action {
                Button(action: {
                    ...
                    .background(
                        Capsule()
                            .fill(themeColor)
                            .shadow(color: themeColor.opacity(0.3), radius: 6, x: 0, y: 2)
                    )
                }
                .buttonStyle(ScaleButtonStyle())
            }
