    ...
    private func loadContacts() {
        ...
        Task {
            ...
            if status == .notDetermined {
                ...
                print("⚠️ 通讯录权限被拒绝或受限")
                await MainActor.run {
                    errorMessage = "通讯录权限已被拒绝。请在【设置】->【隐私与安全性】->【通讯录】中允许 Matters 访问通讯录。"
                    showError = true
                    isLoading = false
                }
                return
            ...
            HStack(spacing: 16) {
                ...
                if contact.isDuplicate {
                    ...
                    Image(systemName: isSelected ? "checkmark.circle.fill" : "circle")
                        .font(.system(size: 24, weight: .medium))
                        .foregroundColor(isSelected ? Color(red: 0.85, green: 1.0, blue: 0.25) : Color.black.opacity(0.2))
                }
                    ...
                    .fill(
                        ...
                        LinearGradient(
                            colors: [
                                ...
                                Color(red: 0.78, green: 0.98, blue: 0.2).opacity(0.05)
                            ],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                        ) :
